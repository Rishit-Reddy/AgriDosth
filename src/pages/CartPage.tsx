        ...
        const fetchProducts = async () => {
            const productDetails = await Promise.all(
                cartItems.map(async (item) => {
                    ...
                    return { ...productDoc.data(), quantity: item.quantity, productId: item.productId };
                })
            );
                    ...
                    <div className="grid grid-cols-12">
                        ...
                        <div className="col-span-12 xl:col-span-4 bg-gray-50 w-full max-xl:px-6 max-w-3xl xl:max-w-lg mx-auto lg:pl-8 py-24">
                            ...
                            <div className="mt-8">
                                ...
                                <form>
                                    <label className="flex items-center mb-1.5 text-gray-600 text-sm font-medium">Shipping Address</label>
                                    ...
                                    <div className="flex items-center justify-between py-8">
                                        <p className="font-medium text-xl leading-8 text-black">{totalItems} Items</p>
